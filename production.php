...
<head>
  ...
  <title>Department Production</title>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-table"></i> DEPARTMENT PRODUCTION</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="profile.php">Home</a></li>
              <li><i class="fa fa-th-list"></i>List Employees</li>
              <li><i class="fa fa-th-list"></i>Production</li>
            </ol>
          </div>
        </div>
        <!-- page start-->
                ...
                <table class="table">
                  ...
                  <tbody>
                   <?php include 'koneksi.php';
                        $proses=$mysqli->query("SELECT nip, nama, tgl, kota, kontak, departemen from karyawan where departemen='Production'");
                        ?>
